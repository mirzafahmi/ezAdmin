...
urlpatterns = [
    ...
    path('task/quotation/list/', views.quotation_details, name = 'task-quotation-list'),
    ...
    path('task/quotation/details/<int:pk>/pdf/', views.quotation_pdf, name = 'task-quotation-pdf'),
