...
class ElectronicUserLocationAdmin(admin.ModelAdmin):
    list_display = ['company_name', 'careholder_name', 'phone_number']
...
class ElectronicPurchasingDocumentAdmin(admin.ModelAdmin):
    list_display = ['supplier', 'po_number', 'po_doc', 'invoice_number', 'invoice_doc']
    list_filter = ['supplier']

class ElectronicInventoryAdmin(admin.ModelAdmin):
    list_display = ['electronic_item', 'serial_number', 'price_per_unit', 'date_of_purchase', 'purchasing_document', 'status', 'remark', 'display_previous_user']
...
class ElectronicTransactionAdmin(admin.ModelAdmin):
    list_display = ['current_user', 'electronic_item', 'transaction_type', 'initial_agreement_doc', 'return_agreement_doc']
