...
urlpatterns = [
    ...
    path('production_main/raw_material_main/raw_material_inventory_main/create/<str:stock_type>', RawMaterialInventoryCreateView.as_view(), name='purchasing-raw-material-inventory-create'),
    #path('production_main/raw_material_main/raw_material_inventory_main/ajax', RawMaterialInventoryAJAX.as_view(), name='purchasing-raw-material-inventory-ajax'),
    #path('production_main/raw_material_main/raw_material_inventory_main/list', RawMaterialInventoryListView.as_view(), name='purchasing-raw-material-inventory-list'),
    #path('production_main/raw_material_main/raw_material_inventory/<int:pk>-update/', RawMaterialInventoryUpdateView.as_view(), name='purchasing-raw-material-inventory-update'),
    #path('production_main/raw_material_main/raw_material_inventory/<int:pk>-delete/', RawMaterialInventoryDeleteView.as_view(), name='purchasing-raw-material-inventory-delete'),
    path('production_main/raw_material_main/raw_material_inventory_identifier_based_main', RawMaterialInventoryIdentifierBasedListView.as_view(), name='purchasing-raw-material-inventory-identifier-based-list'),
    path('production_main/raw_material_main/raw_material_inventory_identifier_based_main/identifier:<int:identifier_id>-component-main', RawMaterialInventoryIdentifierComponentBasedListView.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-list'),
    path('production_main/raw_material_main/raw_material_inventory_identifier_based_main/identifier:<int:identifier_id>-component-main/component:<int:component_id>-list/inventory_log_create_main/create-stock_type:<str:stock_type>', RawMaterialInventoryIdentifierComponentBasedLogCreateView.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-create'),
    path('production_main/raw_material_main/raw_material_inventory_identifier_based_main/identifier_component_based/create/stock_type/ajax', RawMaterialInventoryIdentifierComponentBasedLogCreateAJAX.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-create-ajax'),
    ...
    path('production_main/raw_material_main/raw_material_inventory_identifier_based_main/identifier:<int:identifier_id>-component-main/component:<int:component_id>-list', RawMaterialInventoryIdentifierComponentBasedLogListView.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-list'),
