...
urlpatterns = [
    ...
    path('production_main/raw_material_inventory_main/create/<str:stock_type>', RawMaterialInventoryCreateView.as_view(), name='purchasing-raw-material-inventory-create'),
