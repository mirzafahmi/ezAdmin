...
urlpatterns = [
    ...
    path('purchasing/raw_material_inventory/identifier_component_based/create/stock_type/ajax', RawMaterialInventoryIdentifierComponentBasedLogCreateAJAX.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-create-ajax'),
    ...
    path('purchasing/raw_material_inventory/identifier:<int:identifier_id>/component:<int:component_id>/stock_type:<str:stock_type>/log:<int:pk>/update', RawMaterialInventoryIdentifierComponentBasedLogUpdateView.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-update'),
    path('purchasing/raw_material_inventory/identifier:<int:identifier_id>/component:<int:component_id>/stock_type:<str:stock_type>/log:<int:pk>/delete', RawMaterialInventoryIdentifierComponentBasedLogDeleteView.as_view(), name='purchasing-raw-material-inventory-identifier-component-based-log-delete'),
]